// Enhanced by AI on 2025-08-10T22:39:53.212Z
// Section: cta
// Category: cta

import { Button } from "@/components/ui/button"
import { Card, CardContent } from "@/components/ui/card"
import { ArrowRight, Calendar, GraduationCap, BookOpen, Atom } from "lucide-react"
import Link from "next/link"

export default function CTA() {
  const stats = [
    { value: "500+", label: "Enrolled Students", icon: GraduationCap },
    { value: "95%", label: "Success Rate", icon: BookOpen },
    { value: "12+", label: "Physics Courses", icon: Atom },
    { value: "24/7", label: "Learning Support", icon: Calendar }
  ]
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Prof. Ouhbi's Physics Courses
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of successful students who have mastered physics with our comprehensive courses.
                From quantum mechanics to astrophysics, start your academic journey today.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Accredited by leading educational institutions
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* University/Institution logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div 
                      key={i} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Choose from morning, afternoon, or evening classes
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Learn directly from Prof. Ouhbi and qualified physics educators
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Access to state-of-the-art physics laboratory equipment
              </p>
            </div>
          </div>
        </div>
